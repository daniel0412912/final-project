    ...
    <div className="min-h-screen px-20">
      <div className="bg-gradient-to-r from-blue-500 to-blue-700 text-white py-8 px-4 text-center rounded-md mb-8">
        ...
        <p className="text-lg mt-2">
          I’m excited to work together. Drop a message below!
        </p>
      </div>
      <form onSubmit={handleSubmit} className="border rounded-md shadow-md p-8">
        <FormInput title="Name" placeholder="Enter your name" type="text" />
        <FormInput title="Email" placeholder="Example@email.com" type="email" />
        <div className="mb-4">
          <label
            htmlFor="message"
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="mt-4 text-lg text-gray-500">
            No backend. Form submitted on github pages will show 404 error.
          </p>
        </div>
      </form>
    </div>
